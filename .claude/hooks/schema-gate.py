...
if state_file.exists():
    ...
    if state.get("phases", {}).get("schema", {}).get("complete"):
        sys.exit(0)  # Allow - schema done

# Block with message to Claude
print("BLOCKED: Schema phase not complete. Create Zod schema first.", file=sys.stderr)
sys.exit(2)
