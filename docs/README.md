...
| Document | Description |
|----------|-------------|
| [planning/VERSION_3.2_OVERVIEW.md](./planning/VERSION_3.2_OVERVIEW.md) | Navigation hub |
| [planning/ENHANCEMENT_ROADMAP_v3.11.0.md](./planning/ENHANCEMENT_ROADMAP_v3.11.0.md) | Strategic overview |
| [planning/COMPREHENSIVE_ENHANCEMENT_PLAN.md](./planning/COMPREHENSIVE_ENHANCEMENT_PLAN.md) | Implementation details |
